...
//           ]}
//         />
//         <Text style={[styles.orText, { color: isDark ? '#aaa' : '#888' }]}>
...
//             borderColor: isDark ? '#202327' : '#E1E1E1',
//           },
//         ]}
//       >
//         <Image
...
//         />
//         <Text
//           style={[styles.socialText, { color: isDark ? '#ddd' : '#333' }]}
//         >
//           Google
//         </Text>
//       </View>
...
const Login = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (isHR) {
        navigation.replace('HomeScree');    // ← Change to your actual HR screen name
      } else {
        navigation.replace('HomeScreen');      // ← Normal employee/student screen
      }
