...
const styles = StyleSheet.create({
  ...
  logoContainer: {
    height: 100, alignItems: 'center', justifyContent: 'center', // elevation: 4, marginBottom: 10,
  },
  logoImage: {
    width: 250,
    height: 150,
  ...
  profileImage: {
    width: 90, height: 90, borderRadius: 100, borderWidth: 1, borderColor: '#f8fafc', shadowColor: '#000',
